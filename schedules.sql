...
CREATE TABLE flights_schedule (id integer NOT NULL PRIMARY KEY, airline varchar (200) NOT NULL, flight_no varchar (10) NOT NULL, trip_type varchar (100) NOT NULL, departure_airport varchar (255) NOT NULL, arrival_airport varchar (255) NOT NULL, departure_date date NOT NULL, return_date date NOT NULL);
